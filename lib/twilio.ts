...
export class TwilioService {
  ...
  static async sendContractorVerificationSMS(phoneNumber: string, businessName: string): Promise<boolean> {
    const message = `NewCountertops.com: Complete your contractor verification for ${businessName}. This helps customers trust your services. Reply VERIFY to confirm this phone number.`
